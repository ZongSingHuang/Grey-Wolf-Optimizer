...
for t in range(run_times):
    ...
    optimizer = GWO(fitness=benchmark.Sphere,
    ...
    optimizer = GWO(fitness=benchmark.Rastrigin,
    ...
    optimizer = GWO(fitness=benchmark.Ackley,
    ...
    optimizer = GWO(fitness=benchmark.Griewank,
    ...
    optimizer = GWO(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = GWO(fitness=benchmark.Rosenbrock,
    ...
    optimizer = GWO(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = GWO(fitness=benchmark.Quartic,
    ...
    optimizer = GWO(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = GWO(fitness=benchmark.Penalized1,
    ...
    optimizer = GWO(fitness=benchmark.Penalized2,
    ...
    optimizer = GWO(fitness=benchmark.Schwefel_226,
    ...
    optimizer = GWO(fitness=benchmark.Step,
    ...
    optimizer = GWO(fitness=benchmark.Kowalik,
    ...
    optimizer = GWO(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = GWO(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = GWO(fitness=benchmark.Branin,
    ...
    optimizer = GWO(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = GWO(fitness=benchmark.Shekel,
                    D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = GWO(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = GWO(fitness=benchmark.Hartmann6,
    ...
    optimizer = GWO(fitness=benchmark.Zakharov,
    ...
    optimizer = GWO(fitness=benchmark.SumSquares,
    ...
    optimizer = GWO(fitness=benchmark.Alpine,
    ...
    optimizer = GWO(fitness=benchmark.Michalewicz,
    ...
    optimizer = GWO(fitness=benchmark.Exponential,
    ...
    optimizer = GWO(fitness=benchmark.Schaffer,
    ...
    optimizer = GWO(fitness=benchmark.BentCigar,
    ...
    optimizer = GWO(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = GWO(fitness=benchmark.Elliptic,
    ...
    optimizer = GWO(fitness=benchmark.DropWave,
    ...
    optimizer = GWO(fitness=benchmark.CosineMixture,
    ...
    optimizer = GWO(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = GWO(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(GWO).csv')
